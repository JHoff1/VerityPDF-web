...
export default function Home() {
  return (
    <main className="shell">
      ...
      <section className="intro" id="top"><p className="kicker">Private by design · Free and open source</p><h1>VerityPDF keeps PDF editing<br />on your device.</h1><p className="summary">VerityPDF lets you edit, merge, organize, and redact PDFs without cloud uploads, accounts, telemetry, or subscriptions.</p><div className="actions"><a className="button" href={downloadUrl("VerityPDF-Setup.exe")}>Download for Windows</a><a className="plain-link" href={repositoryUrl}>View source →</a></div><div className="download" id="downloads"><p>Download for your OS</p><div className="download-links"><a href={downloadUrl("VerityPDF-Setup.exe")}>Windows</a><a href={downloadUrl("VerityPDF.dmg")}>macOS</a><a href={downloadUrl("VerityPDF.AppImage")}>AppImage</a><a href={downloadUrl("VerityPDF.deb")}>DEB</a></div></div></section>
      <ScreenshotCarousel />
